...
int main()
{
    ...
    while (option != 6) {
        ...
        if (option == 1) {
            ...
            for (int i = 0; i < n; i++) {
                ofstream outfile;
                outfile.open("utenti.txt", ios::app);
                // The entire data of a single student is
                // stored line-by-line.
                cout << "Inserisci numero di registrazione: ";
                cin >> data;
                outfile << data << "\t";
                ...
                cout << "Inserisci il tuo id di protocollo: ";
                cin >> proctor;
            ...
            char regno[9];
            cout << "Inserisci il tuo numero di registrazione: ";
            cin >> regno;
            ifstream infile;
            int check = 0;
            ...
            if (check == 0) {
                cout << "Nessun risultato trovato! Riporva :)"
                     << endl;
            }
        }
        ...
        // database of a student.
            ...
            char subcode[7];
            cout << "Inserisci il tuo codice della materia: ";
            cin >> subcode;
            ...
            if (option == 1) {
                cout
                    << "Attenzione! hai bisogno di aggiungere un marcatore"
                    << "dettagli per tutti gli studenti!"
                    << endl;
                for (int i = 0; i < count_n; i++) {
                    fstream file("data3.txt");
